...
const CYCLIC_PATHS = new Set([
  ...
  'var/www/chenghao.li/js/shell/parser.js',
  'var/www/chenghao.li/js/shell/line_editor.js',
  'var/www/chenghao.li/js/shell/shell_core.js',
  COMMANDS_INDEX_PATH,
...
function generateBuddiesListContent() {
  ...
  return `export const buddies = ${JSON.stringify(files, null, 4)};\n`;
}
...
async function runCacheBuster() {
  ...
  while (!stable && iterations < MAX_ITERATIONS) {
    ...
    // 3. Regenerate VFS manifest in-memory using the current fileHashes
